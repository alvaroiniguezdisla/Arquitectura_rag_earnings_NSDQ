...
if __name__ == "__main__":
    ...
    texto_prueba = "Apple reportó ingresos récord en el Q1 2020."
    ...
    texto1 = "Apple reportó resultados financieros"
    texto2 = "Apple anunció ganancias trimestrales"
    texto3 = "El clima de hoy está soleado"
    ...
    if sim_12 > sim_13:
        print(f"\n   ✅ Los textos similares tienen mayor similitud")
    else:
        print(f"\n   ⚠️ Algo raro: la similitud no es la esperada")
