...
class GroqLLM:
    ...
    def generate_response(
        ...
        """
        MÉTODO LEGACY (RAG Directo).
        Genera una respuesta usando chunks pasados explícitamente.
        Mantenido por compatibilidad con tests viejos.
        """
        ...
        system_prompt = "Eres un asistente financiero experto. Responde usando el contexto proporcionado."
    ...
    def _build_context(self, chunks: List[RetrievedChunk]) -> str:
        ...
        for i, chunk in enumerate(chunks, 1):
            ...
            context_parts.append(f"[Chunk {i}] {company} {year}: {chunk.text}")
        return "\n\n".join(context_parts)
